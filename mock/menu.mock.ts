    ...
    body: {
      ...
      data: [
        ...
        },
        {
          ...
          redirect: "dashboard",
          name: "Gateway",
          meta: { title: "网关路由", icon: "api", hidden: false, alwaysShow: true },
          children: [
            {
              path: "dashboard",
        ...
        },
        {
          ...
          children: [
            {
              path: "audit-log",
              component: "security/audit-log/index",
              name: "AuditLog",
              meta: {
                title: "审计日志",
                icon: "document",
            ...
            {
              path: "online-user",
              component: "security/online-user/index",
              name: "OnlineUser",
              meta: {
                title: "在线用户",
                icon: "el-icon-User",
...
const menuMap: Record<string, any> = {
  ...
  9: {
    ...
    routePath: "online-user",
    component: "security/online-user/index",
    perm: "security:online-user:list",
    visible: 1,
    sort: 2,
    icon: "el-icon-User",
    redirect: null,
